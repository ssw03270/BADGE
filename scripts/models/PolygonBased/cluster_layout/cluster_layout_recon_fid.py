...
def main():
    ...
    parser.add_argument('--source_dir', type=str, default='./visualizations/d_model_512_codebook_64', help='Path to the directory containing both predict and gt images.')
