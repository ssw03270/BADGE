...
def main():
    ...
    parser.add_argument('--source_dir', type=str, default='./visualizations/d_model_128_codebook_16', help='Path to the directory containing both predict and gt images.')
