...
def main():
    ...
    parser.add_argument('--checkpoint_path', type=str, default='vq_model_chekcpoints/checkpoint_epoch_500/model.pt', help='Path to the model checkpoint.')
    ...
    with torch.no_grad():
        ...
        for batch in progress_bar:
            ...
            all_coords_outputs.append(batch.cpu().numpy())
