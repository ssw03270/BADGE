...
def main():
    ...
    parser.add_argument('--train_batch_size', type=int, default=2048, required=False, help='Batch size for training.')
    parser.add_argument('--val_batch_size', type=int, default=2048, required=False, help='Batch size for validation.')
