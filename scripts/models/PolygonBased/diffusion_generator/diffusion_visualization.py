...
def main():
    ...
    parser.add_argument('--output_dir', type=str, default='inference_outputs/d_512_coords_continuous_norm_blk_generate_retrieval', help='Directory where inference results are saved.')
