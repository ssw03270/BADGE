...
class EncoderLayer(nn.Module):
    ...
    def forward(self, enc_input, t, mask=None):
        """
        ...
        enc_output = self.self_attn(enc_input, enc_input, enc_input, mask=mask, t=t)
        enc_output = self.pos_ffn(enc_output, t=t)
...
class DecoderLayer(nn.Module):
    ...
    def forward(self, dec_input, t, enc_output, dec_mask=None, enc_mask=None):
        """
        ...
        dec_output = self.self_attn(dec_input, dec_input, dec_input, mask=dec_mask, t=t)
        dec_output = self.cross_attn(dec_output, enc_output, enc_output, mask=enc_mask, t=t)
        dec_output = self.pos_ffn(dec_output, t=t)
